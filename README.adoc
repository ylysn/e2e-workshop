...
=== Step 9(a): For Reading only: Iceberg Architecture
...
DESCRIBE HISTORY <wuser00>_stocks.stock_intraday_1min;
----
...
Check the Iceberg table.
[,sql]
----

describe formatted <user50>_stocks.stock_intraday_1min;
----
