...
a. Go to website https://www.alphavantage.co/[Alpha Vantage] +.
b. Choose link \-> 'GET YOUR FREE API KEY TODAY'.

image::images/alphaVantagePortal.png[]

c. Choose 'Student' for description +.
d. Enter your own organisation name +.
...
+ Please keep it with you, if you have forgotten it, don't panic, you will be able to repeat this process and define another one.
