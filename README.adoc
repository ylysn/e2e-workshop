...
You can use the workshop project cloning this github repository : https://github.com/DashDipti/e2e-cdp-alphavantage [Workshop Github repo]
...
{blank}
Scroll up the page here (https://github.com/DashDipti/e2e-cdp-alphavantage) and click on `<> Code` and then choose the option `Download ZIP`. +
